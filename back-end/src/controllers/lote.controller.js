...
export const listarlote= async (req,res)=>{
    try{
        ...
        const[result]= await pool.query("select l.id, l.fecha_creacion, l.nombre, l.latitud, l.longitud, l.n_plantas, f.nombre as Nombre_Finca, l.estado from lotes l join fincas f on f.id = l.fincas_id order by l.estado desc, l.fecha_creacion DESC");
